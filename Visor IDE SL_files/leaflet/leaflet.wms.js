...
wms.Source = L.Layer.extend({
    ...
    //Metodo que crea el objeto hijo, si es un overlay o un tiled
    ...
    //Metodo que aplica el comportamiento sobre el mapa si no esta seteado en false
    'getEvents': function() {
    ...
    'identify': function(evt) {
        ...
        var layers = this.getIdentifyLayers(); //Obtenemos las capas
        if (!layers.length) {
            return;
        }
        this.getFeatureInfo(
    ...
    'getFeatureInfo': function(point, latlng, layers, callback) {
        ...
        var params = this.getFeatureInfoParams(point, layers),  //obtiene los parametros
            url = this._url + L.Util.getParamString(params, this._url); //genera la url con los parametros
        ...
        function done(result) {
            ...
            callback.call(this, latlng, text); //llama a showFeatureInfo
        }
    },
    ...
    'parseFeatureInfo': function(result, url) {
        ...
        if (result == "error") { //Ver si el error lo escondemos cuando este listo VER
